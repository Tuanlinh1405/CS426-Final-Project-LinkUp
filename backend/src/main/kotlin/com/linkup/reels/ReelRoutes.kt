    ...
    authenticate {
        route("/reels") {
            ...
            route("/{id}") {
                ...
                get("/comments") { call.reelGuard { val user = call.reelUser(repository); call.respond(repository.comments(ReelRepository.uuid(call.parameters["id"]), user, call.request.queryParameters["cursor"], call.pageLimit())) } }
                ...
                put("/comments/{commentId}/reaction") { call.reelGuard { val user = call.reelUser(repository); call.respond(repository.likeComment(ReelRepository.uuid(call.parameters["id"]), ReelRepository.uuid(call.parameters["commentId"]), user, true)) } }
                delete("/comments/{commentId}/reaction") { call.reelGuard { val user = call.reelUser(repository); call.respond(repository.likeComment(ReelRepository.uuid(call.parameters["id"]), ReelRepository.uuid(call.parameters["commentId"]), user, false)) } }
